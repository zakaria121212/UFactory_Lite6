...
class ControllersYAML(BaseYamlSubstitution):
    ...
    def describe(self):
        ...
        return 'ControllersYAML(file_path={}, package_path={}, prefix={}, robot_type={}, robot_dof={}, add_gripper={}, add_bio_gripper={}, controllers_name={})'.format(
    ...
    def perform(self, context):
        ...
        # Allow gripper controllers for all robot types, including 'lite'
        if add_gripper:
